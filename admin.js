...
async function cargarConfig() {
  ...
  document.getElementById('cfg-titulo').value     = c.viajeTitulo      || '⏱ Viaje de Egresados';
...
async function guardarConfig() {
  try {
    await Store.setConfig({
      ...
      viajeFecha:       document.getElementById('cfg-fecha').value ? document.getElementById('cfg-fecha').value + ':00' : '',
    ...
    console.error('guardarConfig error:', e);
